...
public class TabActivity_List_Contract extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TabActivity_List_Contract.this,MainActivity.class));
            }
        });
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Activity_Detail_Contract.actionStart(TabActivity_List_Contract.this,new Contract());
            }
        });
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 1:
                    ...
                    return  ContractListFragment.getInstance_staffid(myApp.getStaffID());
            }
            return null;
        }
