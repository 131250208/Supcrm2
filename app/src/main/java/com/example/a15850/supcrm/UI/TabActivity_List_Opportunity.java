...
public class TabActivity_List_Opportunity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TabActivity_List_Opportunity.this,MainActivity.class));
            }
        });
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Activity_Detail_Opportunity.actionStart(TabActivity_List_Opportunity.this,new Opportunity());
            }
        });
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 1:
                    ...
                    return OpportunityListFragment.getInstance_staffid(myApp.getStaffID());
            }
            return null;
        }
