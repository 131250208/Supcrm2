...
public class TabActivity_List_Contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TabActivity_List_Contact.this,MainActivity.class));
            }
        });
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Activity_Detail_Contact.actionStart(TabActivity_List_Contact.this,new Contact());
            }
        });
